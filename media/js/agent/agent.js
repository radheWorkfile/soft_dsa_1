        ...
        printTable: function(search_data) {
            ...
            $("#leadtable").DataTable({
                ...
                "ajax": {
                    ...
                    "url": base_url + 'agent/Agent/agent_data',
                    "type": "POST",
                    "dataSrc": "data",
                    "data": search_data
...
function view_agent(id) {
    $.ajax({
        url: base_url + 'agent/Agent/view_agent_data',
        type: "POST",
        data: {
            'id': id
        },
...
function update_agent(id) {
    $.ajax({
        url: base_url + 'agent/Agent/update_agent',
        type: "POST",
        data: {
            'id': id
        },
...
$('#agent_updata').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'agent/Agent/update_agent_data',
        type: "POST",
        data: new FormData(this),
        processData: false,
        contentType: false,
