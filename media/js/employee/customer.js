...
function get_loan_type_data(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/get_loan_type_doc',
        type: "POST",
        data: {
        ...
        success: function(data) {
            ...
            $.each(data, function(i, item) {
                if (parseInt(item) == 1) {
                    ...
                    str = `<div class="col-lg-6"><input type="checkbox" name="loan_type_document" id="loan_type_document" value="${item}"> Age Proof<br><input class="form-control" type="file" name="loan_age_proof" id="loan_age_proof"></div>`;
                    ...
                    str = `<div class="col-lg-6"><input type="checkbox" name="loan_type_document" id="loan_type_document" value="${item}"> Passport<br><input class="form-control" type="file" name="loan_passport" id="loan_passport"></div>`;
...
function get_agent_data(id) {
    $.ajax({
        url: base_url + 'employee/Customer/get_agent_data',
        type: "POST",
        data: {
            'id': id
        },
        ...
        printTable: function(search_data) {
            ...
            $("#leadtable").DataTable({
                ...
                "ajax": {
                    ...
                    "url": base_url + 'employee/Customer/customer_data',
                    "type": "POST",
                    "dataSrc": "data",
                    "data": search_data
...
$('#add_customer_data').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'employee/Customer/add_customer_data',
        type: "POST",
        ...
        success: function(data) {
            if (data.icon == "error") {
                ...
                setTimeout(function() {
                    ...
                    window.location.href = base_url + 'employee/Customer/manage_customer';
                }, 1500);
            }
        }
    });
...
function view_customer(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/view_customer',
        type: "POST",
        data: {
            'id': id
        },
...
function view_pending_response(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/view_pending_response',
        type: "POST",
        data: {
            'id': id
        },
...
function view_approve_response(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/view_approve_response',
        type: "POST",
        data: {
            'id': id
        },
...
function view_reject_response(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/view_reject_response',
        type: "POST",
        data: {
            'id': id
        },
...
function update_customer(id) {
    $.ajax({
        url: base_url + 'employee/Customer/update_customer',
        type: "POST",
        data: {
            'id': id
        },
...
function assign_bank(id) {

    $.ajax({

        url: base_url + 'employee/Customer/assign_bank',
        type: "POST",
        data: {
            'id': id
        },
...
$('#customer_updata').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'employee/Customer/update_basic_customer_data',
        type: "POST",
        data: new FormData(this),
        processData: false,
        contentType: false,
...
$('#bank_assign').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'employee/Customer/assign_bank_data',
        type: "POST",
        data: new FormData(this),
        processData: false,
        contentType: false,
...
function update_customer_document(id) {
    ...
    $.ajax({
        url: base_url + 'employee/Customer/update_customer_document',
        type: "POST",
        data: {
            'id': id
        },
...
$('#customer_doc_updata').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'employee/Customer/update_customer_document_data',
        type: "POST",
        data: new FormData(this),
        processData: false,
        contentType: false,
