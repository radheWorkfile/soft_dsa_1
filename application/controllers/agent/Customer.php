<?php
    ...
    class Customer extends CI_Controller
    {
        public function __construct()
        {
            ...
            $this->load->model('agent/Customer_model', 'customer_model');
        ...
        public function add_customer_data() {
            ...
            if($this->form_validation->run() == TRUE) {
                ...
                $data = array('icon' => 'success', 'text' => 'New Customer Added Successfully');
        ...
        public function customer_data()
        {
            ...
            foreach ($record as $row) {
                ...
                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target=".update_category" onclick="update_customer(' . $row->id . ')" title="Click to Update Staff Details"><i class="fas fa-edit"></i></a>&emsp;
        ...
        public function view_customer() {
            ...
            if($this->input->is_ajax_request()) {
                ...
                $this->load->view('agent/customer/view_customer', $data);
        ...
        public function view_pending_response() {
            ...
            if($this->input->is_ajax_request()) {
                ...
                $view = $this->input->post();
                $data['view_customer'] = $this->customer_model->get_customer_data($view['id']);
                $this->load->view('agent/customer/view_reason', $data);
        ...
        public function update_customer() {
            ...
            if($this->input->is_ajax_request()) {
                ...
                $data['agent']        = $this->common_model->all_data('agent', 'id, agent_id, name');
                $data['employee']     = $this->common_model->all_data('employee', 'id, employee_id, name');
                $this->load->view('agent/customer/update_customer', $data);
        ...
        public function update_basic_customer_data() {
            ...
            if($this->form_validation->run() == TRUE) {
                ...
                $staff = array(
                    ...
                    'description'             => $add['description'],
                    'document_status'         => $add['document_status'],
                    'next_follow_up_feedback' => $add['next_follow_up_feedback'],
                    'next_follow_date'        => $add['next_follow_date'],
                ...
                $this->common_model->update_data('customer_document', array('customer_id' => $add['customer_id']), $cust);
    ...
    public function id_Card() 
    {
        ...
        $data['title'] = 'Nikhil Sir';
        $data['cus_details'] = $this->common_model->getCus_details($data); 
        $this->load->view('agent/customer/id_card_download',$data);
