<?php
    ...
    class Employee extends CI_Controller
    {
        public function __construct()
        {
            ...
            $this->load->model('super_admin/Employee_model', 'employee_model');
        ...
        public function employee_data()
        {
            ...
            foreach ($record as $row) {
                ...
                $status = ($row->status == 1) ? '
                <a style="color:green; margin-left:-5px;" href="javascript:void()" onClick="return changeStatus(\'' . $row->id . '\',\'0\',\' employee\',\'super_admin/common/chageStatus\')" title="Click to Di-Active employee"><b><i class="fa fa-check"></i> </b></a>&emsp;'
                :
                '<a style="color:red; margin-left:-5px;"  href="javascript:void()"  onClick="return changeStatus(\'' . $row->id . '\',\'1\',\' employee\',\'super_admin/common/chageStatus\')" title="Click to Active employee"><b><i class="fa fa-times"></i> </b></a>&emsp;';
        ...
        {   
            ...
            $this->load->view('super_admin/employee/id_card_man',$data);
        }
        ...
        public function view_employee() {
            ...
            if($this->input->is_ajax_request()) {      
                ...
                $this->load->view('super_admin/employee/view_employee', $data);
            }
        ...
        public function update_employee() {
            ...
            if($this->input->is_ajax_request()) {
                ...
                $this->load->view('super_admin/employee/update_employee', $data);
    ...
    public function download_idcard()
  {
        ...
        $this->load->view('super_admin/employee/id_card_details.php',$data);
  }
