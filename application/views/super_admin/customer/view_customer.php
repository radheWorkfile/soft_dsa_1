                ...
                <div class="col-6 col-sm-6">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Identifier Name</b>
                            <a style="float: right;">
                                <?php echo $view_customer['agent_name']; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Identifier Mobile No.</b>
                            <a style="float: right;">
                                <?php echo $view_customer['identifier_number']; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Identifier Email</b>
                            <a style="float: right;">
                                <?php echo $view_customer['identifier_email']; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Pan No.</b>
                        ...
                        <li class="list-group-item">
                            <b>Assign_employee</b>
                            <a style="float: right;">
                                <?php echo $view_customer['employee_name'] . "(". $view_customer['employee_id'] .")" ; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Password</b>
