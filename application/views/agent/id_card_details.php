        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="">
                    ...
                    <p style="position:absolute;top:3.4rem;left: 21.3rem;color:white;"><img src="<?php echo base_url(); ?>media/images/user.png" alt="" style="height:5rem;"></p>
                    ...
                    <p style="position:absolute;top:13.5rem;left:18rem;font-size:0.5rem;color:#e9ebed;">Id No&nbsp;- <span><?php echo $cus_details['agent_id'] ?></span></p>
