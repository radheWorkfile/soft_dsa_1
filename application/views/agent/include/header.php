        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url() . 'agent/common/profile' ?>"><i class="mdi mdi-account-circle text-muted font-size-16 align-middle me-1"></i> <span class="align-middle" key="t-profile">Profile</span></a>
            ...
            <!-- <div class="dropdown d-inline-block pt-2">
                <a href="<?php echo base_url('agent/setting/basic_setting'); ?>"  class="header-item noti-icon waves-effect mt-2">
