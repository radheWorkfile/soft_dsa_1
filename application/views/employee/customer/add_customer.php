                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="customer_type" id="doc" onchange="return get_document(this.value)" class="form-control">
                                                        <option value=""> ---- Select One ---- </option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="loan_amount" id="loan_amount" class="form-control" placeholder="Enter Loan Amount">
                                                </div>
                                            </div>
                                            <div class="col-lg-6" id="sal_photo_section" style="display: none;">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="file" name="sal_photo"
                                                        id="sal_photo">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="example-number-input" class="form-label"> Collateral
                                                        Document <span class="text-danger" style="font-weight: 600; font-family: 'Font Awesome 5 Free'; font-size: 15px;">(Maximum Size 2MB)</span>
                                                    </label>
                                                    <input class="form-control" type="file" name="collateral_document" id="collateral_document">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
...
<!-- JavaScript -->
<script src="<?php echo base_url() ?>media/js/employee/customer.js"></script>
