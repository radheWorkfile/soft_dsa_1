...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="loantable" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Sl. No.</th>
                            <th>Full Name</th>
...
<div class="modal fade update_category" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="loan_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<div class="modal fade view_pending_model" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    aria-hidden="true">
...
<div class="modal fade view_approve_model" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade view_reject_model" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
...
<script src="<?php echo base_url() ?>media/js/customer/pending_loan.js"></script>